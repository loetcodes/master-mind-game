...
let board_hole_url = ["./images/02_Line_6.png", "./images/03_Answer_box_6.png"];
...
function checkAnswer() {
	...
	if (curr_row.includes(0)) {
		...
		row_poses = [0, 0, 0, 0, 0, 0]; // reset the row poses to 0
	}
